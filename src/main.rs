...
fn argument_parser() -> ArgMatches {
    Command::new(release::DISPLAY_NAME)
        ...
        .subcommand(Command::new("quiz")
            .about("Take David's quizzes")
            .arg(Arg::new("animals")
                .long("animals")
                .action(ArgAction::SetTrue)
                .help("Take a Quiz about Animals"))
            .arg(Arg::new("mil-av")
                .long("mil-av")
                .action(ArgAction::SetTrue)
                .help("Take a military aviation Quiz"))
            .arg(Arg::new("gen-av")
                .long("gen-av")
                .action(ArgAction::SetTrue)
                .help("Take a general aviation Quiz"))
            .arg(Arg::new("strek")
                .long("strek")
                .action(ArgAction::SetTrue)
                .help("Take a Star Trek Quiz"))
            .arg(Arg::new("swars")
                .long("swars")
                .action(ArgAction::SetTrue)
                .help("Take a Star Wars Quiz"))
        ...
        .subcommand(Command::new("conv")
            .about("An number of conversions the program can perform for you")
            .arg(Arg::new("F")
                .long("F")
                .short('f')
                .num_args(1)
        ...
        .subcommand(Command::new("dave-land")
            .about("This is a text based adventure game"))
        .subcommand(Command::new("snake")
            .about("This is a classic Snake game"))
        .subcommand(Command::new("breakout")
            .about("This is a classic Break game, written with Bevy"))
        ...
        .subcommand(Command::new("st-buttons")
            .about("A series of 2D button stress tests for your system")
            .arg(Arg::new("buttons")
                .long("buttons")
                .value_parser(value_parser!(usize))
                .num_args(1)
        ...
        .subcommand(Command::new("get-rand")
            ...
            .arg(Arg::new("bounds")
                ...
                .value_parser(value_parser!(u16))
                .help("Input a minimum and maximum value to get a random value from")))
        .subcommand(Command::new("parse")
            ...
            .arg(Arg::new("file")
                ...
                .num_args(1)
                .value_parser(value_parser!(String))
                .help("Input the file you wish to have parsed")))
        .subcommand(Command::new("note")
            ...
            .arg(Arg::new("complete")
                ...
                .value_name("ID #")
                .num_args(1)
                .help("Complete an existing note by passing the Note ID#, which can be found when running note with '--list'")))
        .subcommand(Command::new("budget")
            ...
            .arg(Arg::new("expense")
                ...
                .value_parser(value_parser!(String))
                .help("Subtract an expense from your budget. Input an expense and an amount"))
            .arg(Arg::new("summary")
                .long("summary")
                .short('s')
                .action(ArgAction::SetTrue)
                .help("Prints a summary of the current budget to the screen")))
        .subcommand(Command::new("currency")
            .about("Dave's implementation of a currency converter. Values as of 3-9-2024")
            .arg(Arg::new("option")
                .long("option")
                .short('o')
                .value_parser(value_parser!(String))
        ...
        .subcommand(Command::new("drm")
            .about("Calculate your max possible repetitions or weight lifted")
            .arg(Arg::new("option")
                .long("option")
                .short('o')
                .default_value("lbs")
